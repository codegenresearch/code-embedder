...
class ScriptContentReader:
    def read_script_content(self, script_paths: list[str]) -> list[ScriptMetadata]:
            ...
            try:
                with open(script_path) as script_file:
                    script_metadata = ScriptMetadata(
                        readme_start=None, readme_end=None, path=script_path, content=script_file.read()
                    )
                    script_contents.append(script_metadata)
...
class ScriptMetadataExtractor:
    def extract_metadata(self, readme_content: list[str]) -> list[ScriptMetadata]:
        ...
        return extractor.extract(readme_content=readme_content)
...
class CodeEmbedder:
    ...
    def _process_readme(self, readme_path: str) -> None:
        ...
        script_contents = self._script_content_reader.read_script_content([script.path for script in scripts])
        self._update_readme(
